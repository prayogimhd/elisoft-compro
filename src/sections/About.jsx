    ...
    return (
        <>
            <Image src="/images/polygon1.svg" alt="images"
                width={199}
                height={291}
                className="absolute lg:-bottom-[450px] md:-bottom-[350px] -bottom-[250px] lg:w-[199px] lg:h-[291px] w-[120px] h-[200px]  right-0"/>
            <Image src="/images/polygon2.svg" alt="images"
                width={199}
                height={291}
                className="absolute lg:-bottom-[550px] md:-bottom-[450px] -bottom-[350px] lg:w-[199px] lg:h-[291px] w-[120px] h-[200px] right-0"/>
            <motion.div className="-mt-[50px] md:mt-0 pt-[275px] bg-[#040229] text-center px-[35px] md:px-[100px] lg:px-[220px]"
                ...
                <motion.p className="text-[20px] md:text-[25px] lg:text-[30px] mt-8"
                    variants={
